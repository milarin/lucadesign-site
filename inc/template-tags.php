 ...
 *
 * 最終的には、ここにある機能の一部がコア機能に置き換わる可能性があります。
 *
 * @package Underscores
 */
...
if ( ! function_exists( 'underscores_entry_footer' ) ) :
	/**
	 * カテゴリ、タグ、コメントのメタ情報を含む HTML を出力します。
	 */
...
if ( ! function_exists( 'underscores_post_thumbnail' ) ) :
	 ...
	 * オプションの投稿サムネイルを表示します。
	 *
	 * 投稿のサムネイルをインデックス ビューのアンカー要素、または単一ビューの場合は div 要素でラップします。
	 */
